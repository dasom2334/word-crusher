...
describe("Result Component Test", () => {
  it("Get Strike Result", async () => {
    ...
    expect(await screen.findAllByText(/krone/i)).toBeTruthy();
  });
  ...
  it("Get Strike And Ball Result", async () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: /submit/i }));
    expect(await screen.findAllByText(/krone/i)).toBeTruthy();
    fireEvent.click(screen.getByRole("button", { name: /remove ball R/i }));
    fireEvent.click(screen.getByRole("button", { name: /remove ball N/i }));
    userEvent.type(
    ...
    fireEvent.click(screen.getByRole("button", { name: /submit/i }));
    expect(await screen.findAllByText(/knife/i)).toBeTruthy();
  });
});
